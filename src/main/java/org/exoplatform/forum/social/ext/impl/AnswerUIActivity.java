package org.exoplatform.forum.social.ext.impl;
...
@ComponentConfig(lifecycle = UIFormLifecycle.class, template = "classpath:groovy/templates/forum/social/AnswerUIActivity.gtmpl", events = {
